...
from test.doubles.test_order_repository import  MockOrderRepository
from test.doubles.test_shipment_service import MockShipmentService


class TestOrderShipmentUseCase:
    def setup_method(self):
        self.order_repository = MockOrderRepository()
        self.shipment_service = MockShipmentService()
